"""
練習問題：メモ帳アプリにJavaScriptで機能を追加しよう

018_ownership_crudで作ったメモ一覧・詳細・追加・編集・削除・認証の機能は
すでに実装済みです（is_pinnedカラム・toggle-pinルートも追加済み）。
static/script.js のTODOコメントの箇所にJavaScriptを書いて完成させてください。
